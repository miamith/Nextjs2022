...
export const VentaComercialAgenciaUVDialog =()=> {

  const {isVentaComercialAgenciaUVDialogOpen,
         toggleVentaComercialAgenciaUDialog} = useContext( UIContext );
  ...
  return (
    <div >
       <Dialog
        open={ isVentaComercialAgenciaUVDialogOpen }
        onClose={toggleVentaComercialAgenciaUDialog}
        scroll={scroll}
        aria-labelledby="scroll-dialog-title"
        aria-describedby="scroll-dialog-description"
      >
        <DialogTitle id="scroll-dialog-title">Nueva Venta De Comercial a Agencia </DialogTitle>
               ...
               <Grid item xs={6}>
                  <FormControl fullWidth size='small' disabled>
                    ...
                    <Select variant='filled' label='peracion' value={1} >
                        <MenuItem value={1}>Venta UV</MenuItem>                 
                    </Select>
                  </FormControl>
                </Grid>
        ...
        <DialogActions>
          <Button onClick={toggleVentaComercialAgenciaUDialog}>Cancel</Button>
          <Button
             sx={{ ml: 1, }}
             color="secondary"
