...
export const VentaRecargaComercialUVDialog =()=> {

  const {isVentaRecargaComercialUVDialogOpen,
         toggleVentaRecargaComercialUDialog} = useContext( UIContext );
  ...
  return (
    <div >
       <Dialog
        open={ isVentaRecargaComercialUVDialogOpen }
        onClose={toggleVentaRecargaComercialUDialog}
        scroll={scroll}
        aria-labelledby="scroll-dialog-title"
        aria-describedby="scroll-dialog-description"
      >
        <DialogTitle id="scroll-dialog-title">Nueva Recarga Comercial</DialogTitle>
               ...
               <Grid item xs={6}>
                  <FormControl fullWidth size='small' disabled>
                    ...
                    <Select variant='filled' label='peracion' value={1} >
                        <MenuItem value={1}>Cuenta de Credito</MenuItem>                 
                    </Select>
                  </FormControl>
                </Grid>
        ...
        <DialogActions>
          <Button onClick={toggleVentaRecargaComercialUDialog}>Cancel</Button>
          <Button
             sx={{ ml: 1, }}
             color="secondary"
