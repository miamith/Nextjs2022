...
return (
  <MlineLayout titulo={'M-line App -Envio'} paginaDescripcion={'M-line su aplicacion de envios y recibos de dinero'}>
    ...
    <Typography variant='h2' sx={{mb:1}}>Enviar dinero</Typography>
          ...
          <Stack spacing={1}>
            ...
            <Grid item xs={12}>
              ...
              <Stack spacing={2} direction='row'>
                ...
                <Grid item xs={12}>
                      <TextField size="small" label="Nº Documento" variant='filled' fullWidth />
                </Grid>
                <Grid item xs={12}>
          ...
          <Stack spacing={1}>
            ...
            <Grid item xs={12}>
               <Stack direction='row' spacing={1}>
                      <TextField size="small" label="Nombre completo" variant='filled' fullWidth />     
                      <TextField size="small" label="Código secreto" variant='filled' fullWidth />
               </Stack>  
            </Grid>
            <Grid item xs={12}>
               <Stack direction='row' spacing={2}>
                  ...
                  <TextField size="small" disabled label="Comision" type='number' variant='filled' fullWidth />
