...
const DetallesOperacionMovilPage = () => {
     ...
     >
      ...
      <Grid container spacing={2} justifyContent='center'>
       ...
       <Grid item xs={5}>
           ...
           <Stack spacing={2} >
                <Grid item xs={12}>
                    <TextField size="small" label="Remitente" variant='filled' fullWidth />
                </Grid>
                <Grid item xs={12}>
                    <TextField size="small" label="Receptor" variant='filled' fullWidth />
                </Grid>
                <Grid item xs={12}>
                    <TextField size="small" label="Identificacion socio" variant='filled' fullWidth />
                </Grid>
                <Grid item xs={12}>
                  <FormControl fullWidth size='small'>
                    <InputLabel>Operador</InputLabel>
                    <Select variant='filled' labelId='Operador' value={1} >
        ...
        <Grid item xs={5} > 
          <Stack spacing={2}>
                ...
                <Grid item xs={12}>
                    <TextField size="small" label="Monto a cobrar" variant='filled' fullWidth />
                </Grid>
                <Grid item xs={12}>
...
export default DetallesOperacionMovilPage